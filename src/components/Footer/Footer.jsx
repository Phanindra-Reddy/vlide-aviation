...
const Footer = () => {
  return (
    <>
      <footer className="relative pb-10 pt-20 bg-black text-white lg:pb-20 lg:pt-[120px] rounded-tl-4xl rounded-tr-4xl">
            ...
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div className="mb-10 w-full">
                  <a
                    href="/#"
                    className="mb-6 inline-block max-w-[160px] text-5xl font-bold"
                  >
                    Vlide
                  </a>
              ...
              <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div>
                  ...
                  <p className="my-4 text-sm text-gray-300 max-w-full lg:max-w-lg">
        ...
        <div className="w-full max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between">
          <p>&copy; {year} All Rights Reserved. Vlide Aviation Pvt Ltd.</p>
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <Link
        to={link}
        className="inline-block text-base font-light text-gray-300 leading-loose text-body-color hover:text-white"
      >
        {label}
      </Link>
    </li>
